REM ###########################################################################
REM #  Copyright (c) 2014-2018 libbitcoin-consensus developers (see COPYING).
REM #
...
call :bld_repo libbitcoin-consensus
IF %ERRORLEVEL% NEQ 0 (
  call :failure "Building libbitcoin-consensus failed."
  exit /b 1
)
