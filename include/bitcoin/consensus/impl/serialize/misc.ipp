 ...
 */
#ifndef LIBBITCOIN__CONSENSUS_MISC_IPP
#define LIBBITCOIN__CONSENSUS_MISC_IPP
...
BCX_API uint32_t inventory_type_to_number(inventory_type_id inv_type);
BCX_API inventory_type_id inventory_type_from_number(uint32_t raw_type);
