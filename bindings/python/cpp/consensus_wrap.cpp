...
SWIGINTERN PyObject *_wrap_verify_script(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOO:verify_script",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_uint8_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "verify_script" "', argument " "1"" of type '" "uint8_t const *""'"); 
  }
  ...
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "verify_script" "', argument " "3"" of type '" "uint8_t const *""'"); 
  }
  ...
  arg4 = static_cast< size_t >(val4);
  {
    ...
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "verify_script" "', argument " "5"" of type '" "uint32_t""'"); 
    }  
    if (!argp5) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "verify_script" "', argument " "5"" of type '" "uint32_t""'");
    } else {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res6)) {
      SWIG_exception_fail(SWIG_ArgError(res6), "in method '" "verify_script" "', argument " "6"" of type '" "uint32_t""'"); 
    }  
    if (!argp6) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "verify_script" "', argument " "6"" of type '" "uint32_t""'");
    } else {
      uint32_t * temp = reinterpret_cast< uint32_t * >(argp6);
      arg6 = *temp;
